...
Harvest:   lorax.py --mode harvest --radio 192.168.8.179 --dest '!YOUR_NODE_ID'
Recv:      lorax.py --mode recv    --radio serial --output ./loot --extract
Scan:      lorax.py --mode scan    --radio 192.168.8.179
Probe:     lorax.py --mode probe   --radio 192.168.8.179 --dest '!YOUR_NODE_ID'
Bench:     lorax.py --mode bench   --radio 192.168.8.179 --dest '!YOUR_NODE_ID'
"""
...
Examples:
  lorax.py --mode harvest --radio 192.168.8.179 --dest '!YOUR_NODE_ID'
  lorax.py --mode harvest --radio 192.168.8.179 --dest '!YOUR_NODE_ID' --harvest-only ssh,aws
  lorax.py --mode recv    --radio serial --output ./loot --extract
  lorax.py --mode probe   --radio 192.168.8.179 --dest '!YOUR_NODE_ID'
  lorax.py --mode bench   --radio 192.168.8.179 --dest '!YOUR_NODE_ID' --delay 5
  lorax.py --mode send    --radio 192.168.8.179 --file id_rsa --dest '!YOUR_NODE_ID' --delay 5
...
E2E encryption:
  ...
  lorax.py --mode harvest --radio 192.168.8.179 --dest '!YOUR_NODE_ID' --pubkey <base64url>
        """
    )
    ...
    parser.add_argument("--dest",    default="!YOUR_NODE_ID", help="Destination node ID")
