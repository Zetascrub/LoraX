...
```
Sender side:  PING → !YOUR_NODE_ID [yas]        ← sends ping, no reply visible
...
**Without encryption:**
```
LORAX  port=PRIVATE_APP  from=!043aae20  to=!YOUR_NODE_ID  payload=30B  magic=b'LX\x01bsm'
LORAX  port=PRIVATE_APP  from=!043aae20  to=!YOUR_NODE_ID  payload=183B magic=b'LX\x02bsm'
```
...
**With E2E encryption:**
```
LORAX  port=PRIVATE_APP  from=!043aae20  to=!YOUR_NODE_ID  payload=93B  magic=b'LX\x01bsm'
LORAX  port=PRIVATE_APP  from=!043aae20  to=!YOUR_NODE_ID  payload=199B magic=b'LX\x02bsm'
```
